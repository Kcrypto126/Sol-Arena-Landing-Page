    ...
    return (
        <div id="right-content" onScroll={handleScroll} className={`${className} w-full h-[100vh] md:col-span-3 bg-cover bg-no-repeat overflow-auto scrollbar-hide relative bg-[url('/assets/chill/BG_img.png')]`}>
            ...
            <div className=" flex flex-col gap-0 w-full pb-40">
                <div className="w-full relative py-[20px] md:py-[80px]" id="What-is-SOL-Arena">
                ...
                <div className=" w-full relative py-[20px] md:py-[80px]" id="Whats-the-Vision">
                        ...
                        <div className=" pl-5 flex flex-col gap-12" >
                            <div >
                                ...
                                <div className=" text-[16px] space-y-8">
                                    ...
                                    <div>
                                        <Image src={'/assets/chill/high-stack.webp'} alt="" width={1920} height={1080} />
                                    </div>
                                </div>
                            </div>
                            <div id="Community-Driven-Competition-Represent-Your-Coins" className="mt-[-80px] pt-[80px]">
                                ...
                                <div className=" text-[16px] space-y-8">
                                    ...
                                    <div>
                                        <Image src={'/assets/chill/image1098.webp'} alt="" width={1344} height={757} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className=" pl-5 flex flex-col gap-12">
                            ...
                            <div id="Tokenomics" className="mt-[-80px] pt-[80px]">
                                ...
                                <div className=" text-[16px] space-y-8">
                                    ...
                                    <div>
                                        <Image src={'/assets/chill/image1199.webp'} alt="" width={1000} height={1000} />
                                    </div>
                ...
                <div className=" w-full relative py-[20px] md:py-[80px]" id="Who-Are-Your-Partners">
                    <Image src={"/assets/chill/TokenIcon.png"} alt="" width={100} height={100} className=" absolute top-[10%] md:top-[50%] -rotate-45 w-[160px] h-[160px] hidden md:block" />
                    <Image src={"/assets/chill/TokenIcon.png"} alt="" width={100} height={100} className=" absolute -rotate-45 top-[20%] md:top-[60%] left-[10%] w-[120px] h-[120px] hidden md:block" />
                    <Image src={"/assets/chill/TokenIcon.png"} alt="" width={100} height={100} className=" absolute top-[50%] md:top-[80%] w-[140px] h-[140px] left-[5%] hidden md:block" />
                    <Image src={"/assets/chill/TokenIcon.png"} alt="" width={100} height={100} className=" absolute top-[10%] md:top-[60%] right-0 w-[160px] h-[160px] hidden md:block" />
                    <Image src={"/assets/chill/TokenIcon.png"} alt="" width={100} height={100} className=" absolute top-[30%] md:top-[80%] right-[8%] -rotate-45 w-[120px] h-[120px] hidden md:block" />
                    <Image src={"/assets/chill/TokenIcon.png"} alt="" width={100} height={100} className=" absolute top-[50%] md:top-[90%] right-[4%] w-[120px] h-[120px] hidden md:block" />
                    <div className="max-w-[1000px] m-auto text-white flex flex-col gap-12 relative z-20">
                        <div className="relative h-fit">
                        ...
                        <div className=" pl-5 flex flex-col gap-12">
                            ...
                            <div >
                                <div className=" text-[16px] space-y-8">
                                    ...
                                    <div>
                                        <Image src={'/assets/chill/our-partner.webp'} alt="" width={1920} height={1080} />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className=" w-full relative py-[20px] md:py-[80px]" id="How-Do-I-Participate">
                    <div className="max-w-[1000px] m-auto text-white flex flex-col gap-12 relative z-20" >
                        <div className="relative h-fit">
                            <Image src={"/assets/chill/Section2Title.png"} alt="" width={500} height={200} className=" w-[426px] h-[68px]" />
                            <div className="  absolute top-[50%] left-7 translate-y-[-50%] text-black md:text-[28px] text-[20px] font-semibold">
                ...
                <div className=" w-full relative py-[20px] md:py-[80px]" id="Links">
                    <div className="max-w-[1000px] w-full m-auto text-white flex flex-col gap-12" >
                        ...
                        <div className=" px-5 flex flex-row gap-6">
                            <div className="flex-1 md:flex-auto flex flex-row gap-3 items-center cursor-pointer" onClick={() => {navigator.push("https://discord.com/invite/chillchatgames");}}>
                                <Image src={"/assets/chill/ButtonIcon-Discord.png"} alt="" width={48} height={48} />
                                <div className=" text-[#41FFC6] text-[18px] md:w-[240px] ">
                                    Discord
                                </div>
                            </div>
                            <div className="flex-1 md:flex-auto flex flex-row gap-3 items-center md:justify-start justify-between cursor-pointer" onClick={() => {navigator.push("https://x.com/solarena_io")}}>
                            ...
                            <div className="flex-1 md:flex-auto flex flex-row gap-3 items-center cursor-pointer" onClick={() => {navigator.push("https://t.me/solarenaio")}}>
